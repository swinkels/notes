* My Emacs package Orgox to publish my notes                          :emacs:

Currently you're reading a note from a repository of notes I maintain on GitHub,
[[https://github.com/swinkels/notes][swinkels/notes]]. Each note is an Org file and because GitHub has some support for
...
published my notes at my [[https://blog.journeythatcounts.nl][blog.journeythatcounts.nl]] using the static website
generator [[https://gohugo.io/][Hugo]]. This note introduces the Emacs package I developed to convert
the notes to the Markdown files that Hugo expects, named [[https://github.com/swinkels/orgox][Orgox]].

** Why Orgox?

Hugo expects its content to be formatted using Markdown. Although Org can export
Org files to Hugo Markdown files via its exporter [[https://ox-hugo.scripter.co/][ox-hugo]], such an export needs
...
You can find the Hugo website at GitHub repository [[https://github.com/swinkels/notes-as-hugo-blog][swinkels/notes-as-hugo-blog]]:
...
[[https://blog.journeythatcounts.nl][blog.journeythatcounts.nl]].

** Next steps

Writing and publishing a note, or blog post, involves multiple manual steps
across the repos [[https://github.com/swinkels/notes][swinkels/notes]] and [[https://github.com/swinkels/notes-as-hugo-blog][swinkels/notes-as-hugo-blog]]: you have to
...
combination with an Emacs hydra for easy access as described in [[file:../../03/20250323.org][this note]].
...
published an Emacs package to [[https://melpa.org/][MELPA]] before but this might be the package to do
so.
...
[fn:2] For more information, consult the [[https://github.com/swinkels/orgox/blob/main/README.org][Orgox README]].
